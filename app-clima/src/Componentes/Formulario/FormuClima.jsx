    ...
    return (
        <div className='bg-blue-300 m-2 p-2 rounded-lg shadow- text-black flex flex-col justify-center align-center '>
            ...
            <form onSubmit={handleSubmit}>
                <input className='bg-amber-50 rounded-b-sm p-1 border-2 border-black' type="text"required onChange={handleChange} name="lugar" value={form.latitud} placeholder='ingrese un lugar'>
                </input>
